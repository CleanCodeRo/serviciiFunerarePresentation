...
const Hero: React.FC = () => {
  ...
  return (
    <div>
      {isLargeScreen ? (
        <div className="flex-col justify-center items-center text-center mt-60 text-4xl font-primary h-[470px] ">
          <h1>Servicii funerare </h1>
          <AnimatedBall />
        </div>
      ) : (
        <div className="text-center mt-60 text-3xl font-primary h-[390px] ">
          <h1>Servicii funerare </h1>
          <AnimatedBall />
        </div>
      )}
